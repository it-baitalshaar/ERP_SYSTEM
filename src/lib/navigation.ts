...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "procurement-workflow", label: "Process map", href: "/procurement/workflow", icon: "GitBranch", feature_flag: "mod_procurement", module_key: "procurement" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "admin-workflows", label: "Workflow Builder", href: "/admin/workflows", icon: "GitBranch", module_key: "admin" },
