...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    label: "Procurement",
    items: [
      { key: "pr", label: "Purchase Requisitions", href: "/procurement/requisitions", icon: "ClipboardList", feature_flag: "mod_procurement", module_key: "procurement" },
      { key: "po", label: "Purchase Orders", href: "/procurement/orders", icon: "Package", feature_flag: "mod_procurement", module_key: "procurement" },
      ...
      { key: "gr", label: "Goods Receipt", href: "/procurement/goods-receipt", icon: "PackageCheck", feature_flag: "mod_procurement", module_key: "procurement" },
